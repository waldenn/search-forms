const { SearchForm, SearchFormParser } = require('./forms');
...
class SiteActionParser extends SearchFormParser {
  constructor(options) {
    super(options);
  }
  getSearchForms(html, eof = -1) {
    const form = SiteActionParser.getSearchAction(html, eof);
